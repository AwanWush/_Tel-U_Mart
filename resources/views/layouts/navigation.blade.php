<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-md border-b border-gray-100 sticky top-0 z-50 transition-all duration-300">
            ...
            <div class="flex items-center gap-8">
                ...
                <div class="hidden space-x-4 sm:flex">
                    ...
                    <a href="{{ route('dashboard') }}" 
                       class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ease-in-out gap-2
                    ...
                    {{-- Link Tambahan (Contoh buat User Biasa) --}}
                    {{-- <a href="#" class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium text-gray-500 hover:bg-gray-50 hover:text-indigo-600 transition-all gap-2">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white border-t border-gray-100">
        <div class="pt-2 pb-3 space-y-1 px-4">
            ...
            {{-- Kalau mau nambah link mobile di sini --}}
        </div>
