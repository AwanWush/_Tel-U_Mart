<x-app-layout>
                ...
                <ol class="inline-flex items-center space-x-2 md:space-x-3 rtl:space-x-reverse text-sm">
                    <li class="inline-flex items-center">
                        <a href="{{ route('dashboard') }}"
                            class="inline-flex items-center text-xs font-semibold uppercase tracking-wider text-gray-500 hover:text-red-main transition-colors">
                            <svg class="w-3.5 h-3.5 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path
                                    d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 011 1v4a1 1 0 001 1h3a2 2 0 002-2v-7.586l.293.293a1 1 0 001.414-1.414Z" />
                            </svg>
                            Dashboard
                        </a>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-xs font-extrabold uppercase tracking-wider text-red-main">Beli
                                Galon</span>
                        </div>
                    </li>
                </ol>
    ...
    <div class="py-12 min-h-screen bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{
            ...
            <div
                class="bg-white p-8 rounded-[2rem] mb-10 text-gray-800 border-2 border-red-main/10 shadow-xl shadow-red-main/10 transition-all duration-300 hover:shadow-2xl hover:shadow-red-main/15">
                <div class="flex items-center mb-6 border-b border-gray-100 pb-4">
                    ...
                    <h3 class="text-2xl font-black uppercase tracking-wider text-gray-900">Informasi Penghuni Asrama
                    </h3>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    <div
                        class="p-4 rounded-xl border-l-4 border-red-main/80 bg-red-soft/50 shadow-md shadow-gray-200/50 transition-all duration-200 hover:bg-red-soft hover:shadow-lg">
                        <div class="flex items-center mb-1">
                            <svg class="w-4 h-4 mr-2 text-red-main" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div
                        ...
                        <p class="font-extrabold text-gray-900 text-lg ml-6">
                            {{ Auth::user()->lokasi->nama_lokasi ?? (Auth::user()->alamat_gedung ?? '-') }}</p>
                    </div>
                    <div
                        class="p-4 rounded-xl border-l-4 border-red-main/80 bg-red-soft/50 shadow-md shadow-gray-200/50 transition-all duration-200 hover:bg-red-soft hover:shadow-lg">
                        <div class="flex items-center mb-1">
                            <svg class="w-4 h-4 mr-2 text-red-main" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 7h.01M12 7h.01M16 7h.01M21 12v3a2 2 0 01-2 2H5a2 2 0 01-2-2v-3m18-4a2 2 0 00-2-2H5a2 2 0 00-2 2m18 0h.01M19 19H5">
                                </path>
                            </svg>
            ...
            <div class="bg-white shadow-xl rounded-[2.5rem] p-10 md:p-14 border border-gray-100">
                ...
                <div x-show="step === 1" x-cloak class="space-y-8">
                        ...
                        <div class="flex items-center mb-4">
                            <div class="p-3 rounded-full mr-4 bg-red-main text-white shadow-lg shadow-red-main/30">
                                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M11 15.5H9.5a2.5 2.5 0 010-5H11v5zM15 15.5h1.5a2.5 2.5 0 000-5H15v5zM12 2a10 10 0 100 20 10 10 0 000-20zM12 18v2M12 4v2">
                                    </path>
                                </svg>
                            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <label @click="hasGalon = true"
                                ...
                                :class="hasGalon ? 'border-red-main ring-4 ring-red-soft bg-red-soft/50 shadow-red-soft' :
                                    'border-gray-300 bg-white hover:border-red-main/50'">
                                <div class="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-xl mr-4 shadow-lg transition-colors"
                                    :class="hasGalon ? 'bg-red-main text-white shadow-red-main/30' :
                                        'bg-gray-200 text-gray-600 group-hover:bg-red-main group-hover:text-white'">
                                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <label @click="hasGalon = false; pilihanGalon = ''"
                                class="payment-card flex items-center p-6 rounded-2xl cursor-pointer border-2 transition-all shadow-md hover:shadow-lg group"
                                :class="!hasGalon ? 'border-red-main ring-4 ring-red-soft bg-red-soft/50 shadow-red-soft' :
                                    'border-gray-300 bg-white hover:border-red-main/50'">
                                <div class="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-xl mr-4 shadow-lg transition-colors"
                                ...
                                <div>
                                    <span class="font-extrabold text-gray-900 text-xl block">Belum Ada, Botol
                                        Baru</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3 p-4 bg-gray-50 rounded-xl border-l-4 border-red-main/50 shadow-inner">
                            <label class="block text-xl font-bold text-gray-800 tracking-tight flex items-center">
                                <svg class="w-6 h-6 mr-2 text-red-main" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <p class="text-xs text-gray-500 ml-8">Pilih sesuai kebutuhan Anda (Isi Ulang/Botol Baru).
                            </p>
                            <select x-model="pilihanGalon"
                                ...
                                required>
                                <option value="" disabled selected class="text-gray-400">-- Pilih Paket Galon --
                                </option>
                                @foreach ($galons as $g)
                    ...
                    <div class="space-y-4">
                        <label
                            class="block text-gray-800 font-bold text-xl md:text-2xl tracking-tight flex items-center">
                            <svg class="w-6 h-6 mr-2 text-red-main" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <label @click="pengiriman = 'ambil'"
                                class="payment-card flex items-center p-6 rounded-2xl cursor-pointer border-2 transition-all shadow-md hover:shadow-lg group"
                                :class="pengiriman === 'ambil' ?
                                    'border-red-main ring-4 ring-red-soft bg-red-soft/50 shadow-red-soft' :
                                    'border-gray-300 bg-white hover:border-red-main/50'">
                                <div class="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-xl mr-4 shadow-lg transition-colors"
                                    :class="pengiriman === 'ambil' ? 'bg-red-main text-white shadow-red-main/30' :
                                        'bg-gray-200 text-gray-600 group-hover:bg-red-main group-hover:text-white'">
                                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m-5 0v-2a2 2 0 012-2h10a2 2 0 012 2v2M7 5h10">
                            ...
                            <label @click="pengiriman = 'antar'"
                                class="payment-card flex items-center p-6 rounded-2xl cursor-pointer border-2 transition-all shadow-md hover:shadow-lg group"
                                :class="pengiriman === 'antar' ?
                                    'border-red-main ring-4 ring-red-soft bg-red-soft/50 shadow-red-soft' :
                                    'border-gray-300 bg-white hover:border-red-main/50'">
                                <div class="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-xl mr-4 shadow-lg transition-colors"
                                    :class="pengiriman === 'antar' ? 'bg-red-main text-white shadow-red-main/30' :
                                        'bg-gray-200 text-gray-600 group-hover:bg-red-main group-hover:text-white'">
                                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div>
                                    ...
                                    <span class="text-sm text-gray-600 block">+ Rp <span
                                            x-text="(ongkir * jumlah).toLocaleString('id-ID')"></span></span>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3 p-6 bg-red-soft/20 rounded-2xl border-2 border-red-main/30 shadow-md">
                        ...
                        <textarea id="catatanInput" class="form-input-custom focus:ring-red-main focus:border-red-main text-gray-700"
                            rows="3" placeholder="Contoh: titip di depan kamar, tolong tukar 2 botol"></textarea>
                        <p class="text-xs text-gray-600 ml-8">Catatan ini akan diteruskan ke petugas pengantar galon.
                        </p>
                    </div>
                    ...
                    <button type="button" @click="if(pilihanGalon && jumlah >= 1) step = 2"
                        ...
                        <span class="relative z-10 flex items-center justify-center gap-3 uppercase tracking-wider">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 8c1.657 0 3 .895 3 2s-1.343 2-3 2h-1v1h1c1.657 0 3 .895 3 2s-1.343 2-3 2h-1c-1.657 0-3-.895-3-2s1.343-2 3-2h1v-1h-1c-1.657 0-3-.895-3-2s1.343-2 3-2z">
                                </path>
                            </svg>
                ...
                <div x-show="step === 2" x-cloak class="space-y-10">
                    ...
                    <a href="javascript:void(0)" @click="step = 1"
                        ...
                        <div
                            class="w-8 h-8 rounded-full border-2 shadow-md flex items-center justify-center mr-2 btn-back-icon">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                                    d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                            </svg>
                        </div>
                        <span class="font-extrabold text-sm text-gray-900 transition-colors btn-back-text">Kembali ke
                            Pemilihan Galon</span>
                    </a>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div @click="metode = 'cod'"
                            ...
                            <div class="mb-4 w-16 h-16 flex items-center justify-center rounded-2xl transition-all"
                                :class="metode === 'cod' ? 'bg-red-main text-white shadow-lg shadow-red-main/30' :
                                    'bg-gray-100 text-gray-600 group-hover:bg-red-main group-hover:text-white'">
                            ...
                            <p class="text-sm text-gray-600 mt-1 uppercase tracking-widest font-semibold">Bayar
                                Langsung ke Petugas</p>
                            <p class="text-xs text-gray-400 mt-2 italic">(Hanya tersedia untuk jam operasional)</p>
                        </div>

                        <div @click="metode = 'midtrans'"
                            class="payment-card p-8 rounded-3xl cursor-pointer border-2 transition-all bg-white text-center flex flex-col items-center justify-center group shadow-md hover:shadow-xl hover:border-red-main/50"
                            :class="metode === 'midtrans' ?
                                'border-red-main ring-4 ring-red-soft bg-red-soft/50 shadow-red-soft' :
                                'border-gray-200'">
                            <div class="mb-4 w-16 h-16 flex items-center justify-center rounded-2xl transition-all"
                                :class="metode === 'midtrans' ? 'bg-red-main text-white shadow-lg shadow-red-main/30' :
                                    'bg-gray-100 text-gray-600 group-hover:bg-red-main group-hover:text-white'">
                                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8c-2.485 0-4.5 2.13-4.5 4.75 0 2.222 1.488 4.25 4.5 4.25s4.5-2.028 4.5-4.25C16.5 10.13 14.485 8 12 8zM12 18V6M7 12H5m14 0h-2">
                                    </path>
                                </svg>
                            </div>
                            <p class="font-black text-gray-900 text-2xl">MIDTRANS</p>
                            <p class="text-sm text-gray-600 mt-1 uppercase tracking-widest font-semibold">Semua Opsi
                                Pembayaran Online</p>
                    ...
                    {{-- Total Pembayaran --}}
                    <div
                        class="bg-red-soft/30 p-8 rounded-2xl border-2 border-red-main/50 flex flex-col sm:flex-row justify-between items-center shadow-lg shadow-red-main/10">
                        <div class="text-center sm:text-left mb-4 sm:mb-0">
                            <span class="font-extrabold text-red-main uppercase tracking-widest text-lg block">TOTAL
                                PEMBAYARAN</span>
                            <span class="text-xs text-gray-700 font-semibold italic"
                                x-text="'Rincian: ' + jumlah + 'x ' + pilihanGalon"></span>
                        </div>
                        <span class="font-black text-red-main text-4xl sm:text-5xl"
                    ...
                    <button id="btnFinalOrder" @click="handleOrder($data)"
                        ...
                        <span class="relative z-10 flex items-center justify-center gap-3 uppercase tracking-wider">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.003 12.003 0 0012 21.011a12.003 12.003 0 008.618-14.015z">
                                </path>
                            </svg>
                            <span
                                x-text="metode === 'cod' ? 'Konfirmasi & Pesan (Bayar di Tempat)' : 'Bayar Sekarang (Online Payment)'"></span>
                            <svg class="w-5 h-5 transition-transform group-hover:translate-x-1" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
    ...
    <script>
        ...
        async function handleOrder(alpineData) {
            ...
            if (alpineData.metode === 'cod') {
                ...
                form.querySelector('[name=ongkir]').value = alpineData.pengiriman === 'antar' ? (alpineData.ongkir *
                    alpineData.jumlah) : 0;
                form.submit();
            } else {
                btn.disabled = true;
                            ...
                            try {
                                const save = await fetch("{{ route('galon.store.midtrans') }}", {
                                    ...
                                    body: JSON.stringify({
                                        ...
                                        status: 'paid',
                                        metode_pengiriman: alpineData.pengiriman,
