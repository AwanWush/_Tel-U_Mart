    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-800 p-6 rounded-xl shadow text-white">
                ...
                @if ($riwayat->isEmpty())
                    <p class="text-gray-300">Belum ada transaksi galon.</p>
                @else
                    <div class="space-y-4">
                        @foreach ($riwayat as $r)
                            <div class="bg-gray-900 p-4 rounded-lg shadow flex justify-between items-center border border-gray-700">
                                ...
                                <div>
                                    <p class="text-sm text-gray-400">{{ $r->created_at }}</p>
                                    <p class="text-lg font-semibold">{{ $r->nama_galon }}</p>
                                    <p>Rp{{ number_format($r->total_harga, 0, ',', '.') }}</p>
