<x-app-layout>
    ...
    <div x-data="{
        ...
        <div class="flex justify-between mb-4">
            ...
            <input type="text" x-model="search" placeholder="Cari produk..." class="border rounded px-3 py-2 text-sm">
        </div>
                        ...
                        <tr x-show="'{{ strtolower($p->nama_produk) }}'.includes(search.toLowerCase())"
                            ...
                            <td>
                                @forelse($p->marts as $m)
                                    <span
                                        class="inline-block bg-indigo-100 text-indigo-700 px-2 py-1 text-xs rounded mr-1">
                                        {{ $m->nama_mart }}
                                    </span>
                                @empty
