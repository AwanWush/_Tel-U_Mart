<x-guest-layout>
    <div x-data="{ 
         ...
         class="fixed inset-0 z-50 flex bg-white font-sans">

        {{-- BAGIAN KIRI: BRANDING (Sama Persis dengan Login) --}}
        ...
        <div class="w-full lg:w-1/2 h-full bg-gray-50 overflow-y-auto">
            ...
            <div class="min-h-full flex flex-col justify-center py-10 px-6 sm:px-12 lg:px-16 xl:px-20">
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" @submit="loading = true" class="space-y-4">
                    @csrf
            ...
            <x-input-error :messages="$errors->get('nomor_kamar')" class="mt-1" />
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="h-12 w-12 rounded-full bg-gray-200 overflow-hidden flex-shrink-0 border border-gray-300">
                            ...
                            <input type="file" name="gambar" accept="image/*" @change="updatePreview"
                                   class="block w-full text-xs text-gray-500 file:mr-3 file:py-2 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer">
                        </div>
                ...
                {{-- Footer kecil di dalam scroll container agar tidak menumpuk form --}}
