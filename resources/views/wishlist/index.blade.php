<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <span
                class="bg-red-50 text-red-600 px-3 py-1 rounded-full text-[10px] font-bold border border-red-100 uppercase">
                {{ $items->count() }} Produk
            </span>
        </div>
    </x-slot>
                    ...
                    @foreach ($items as $item)
                        <div x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                            ...
                            @php
                                ...
                                $cleanFileName = $gambar
                                    ? str_replace(['produk_assets/', 'produk/', 'public/'], '', $gambar)
                                    : null;
                            ...
                            <div
                                class="relative aspect-square bg-gray-50 rounded-xl overflow-hidden mb-3 border border-gray-50">
                                <img src="{{ $imagePath }}"
                                    alt="{{ $produk->nama_produk ?? 'Produk tidak tersedia' }}"
                            ...
                            <div class="space-y-1">
                                <h3
                                    class="font-bold text-gray-800 text-[11px] line-clamp-2 h-8 leading-tight group-hover:text-red-600 transition-colors">
                                ...
                                <p class="text-red-600 font-black text-sm">
                                    ...
                                    @else
                                        <span class="text-gray-400 text-xs">Produk tidak tersedia</span>
                                    @endif
